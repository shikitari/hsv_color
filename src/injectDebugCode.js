...
(function() {
    ...
    e.innerHTML = "this is develop build";
    e.style.position = "absolute";
    e.style.left = "0px";
    e.style.right = "0px";
    e.style.fontSize = "8px";
    var node = document.getElementById("app");
	// document.body.insertBefore(e, node);
	// document.body.appendChild(e);

	// var script = document.createElement('script');
	// script.setAttribute("src", "OrbitControls.js");
...
window.debug = function(target, property, descriptor) {
	console.log(target);
